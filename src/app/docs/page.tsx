...
const colorMap: Record<string, { bg: string; text: string; border: string }> = {
  emerald: { bg: 'bg-slate-100', text: 'text-slate-600', border: 'border-slate-200' },
  cyan: { bg: 'bg-slate-100', text: 'text-slate-600', border: 'border-slate-200' },
  violet: { bg: 'bg-slate-100', text: 'text-slate-600', border: 'border-slate-200' },
  amber: { bg: 'bg-slate-100', text: 'text-slate-600', border: 'border-slate-200' },
};
      ...
      <section className="pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <p className="text-sm font-semibold text-[--accent] uppercase tracking-wider mb-4">Documentation</p>
            ...
            <div className="max-w-xl mx-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:border-[--accent] focus:outline-none focus:ring-1 focus:ring-[--accent]"
                />
              </div>
            </div>
          </div>
      ...
      <section className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/docs/getting-started" className="block group">
            <div className="bg-slate-900 rounded-2xl p-6 md:p-8 hover:bg-slate-800 transition-colors">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">Get up and running with your first GPU job in minutes</p>
                  </div>
                </div>
            ...
            {quickLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.title}
                  href={link.href}
                  className="group p-6 bg-white border border-slate-200 rounded-xl hover:shadow-md hover:border-slate-300 transition-all"
                >
                  ...
                  <h3 className="font-semibold text-slate-900 mb-1 group-hover:text-[--accent] transition-colors">
                    {link.title}
                  </h3>
                  ...
                  {section.items.map((item) => (
                    <li key={item.label}>
                      <Link
                        ...
                        className="flex items-center gap-2 text-sm text-slate-500 hover:text-[--accent] transition-colors py-1"
                      >
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-3 text-slate-600">
                  <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full" />
                  Zero-knowledge verification of results
                </li>
                <li className="flex items-center gap-3 text-slate-600">
                  <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full" />
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  href="/docs/sdks"
                  className="inline-flex items-center gap-2 px-6 py-3 border border-slate-200 hover:border-slate-300 text-slate-600 hover:text-slate-900 rounded-lg font-semibold transition-all text-sm"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-sm font-semibold text-[--accent] uppercase tracking-wider mb-4">Whitepaper</p>
                <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">
              ...
              <div className="hidden md:flex items-center justify-center">
                <div className="w-48 h-64 bg-white border border-slate-200 rounded-xl flex items-center justify-center shadow-sm">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-slate-900 mb-2">Get help & connect</h2>
            <p className="text-slate-500">Join our community of developers and GPU providers</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <a
              ...
              className="group p-6 bg-white border border-slate-200 rounded-xl hover:shadow-md hover:border-slate-300 transition-all text-center"
            >
              ...
              <h3 className="font-semibold text-slate-900 mb-1">Discord</h3>
              <p className="text-sm text-slate-500">Chat with the community</p>
            </a>
            ...
            >
              ...
              <p className="text-sm text-slate-500">View source & contribute</p>
            </a>
            ...
            >
              ...
              <p className="text-sm text-slate-500">Get dedicated assistance</p>
            </Link>
          </div>
        </div>
      </section>
